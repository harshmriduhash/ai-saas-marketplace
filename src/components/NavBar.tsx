  ...
  return (
    <div>
      <div className="navbar" style={{ position: "relative", height: "100vh" }}>
        ...
        <Link href="/browse" aria-current="page" id="browse">
          <div
        ...
        {user.isSignedIn && (
          <>
            <Link href="/deals" aria-current="page" id="deals">
              <div
                className={`navbar-icon-wrapper ${
                  router.pathname.includes("deals") && "active"
                }`}
              >
                <Icon icon="inbox" />
              </div>
            ...
            <Link href="/sell-an-item" aria-current="page" id="sell">
              <div
                className={`navbar-icon-wrapper ${
                  router.pathname.includes("sell-an-item") && "active"
                }`}
              >
                <Icon icon="sell" />
              </div>
