...
const SellAnItem: NextPage = () => {
  ...
  const [recentlyCreatedProduct, setRecentlyCreatedProduct] =
    ...
    <>
          ...
          >
            ...
            {step === 3 && (
              <div>
                ...
                <div className="align-center mt-4 flex justify-between gap-6">
                  <div className="flex flex-col" style={{ width: "50%" }}>
                    <Input
                      elementType="input"
                      id="ttm_profit"
            ...
            {(step == 1 || step == 2 || step == 3) && (
              <div className="flex flex-row gap-4">
                ...
                <div className="btn next-btn" onClick={goNext}>
                  Next
                </div>
              </div>
            )}
            ...
            {step == 4 && (
              <>
                <button type="submit" className="btn next-btn" onClick={finish}>
                  List my application
                </button>
      ...
      {recentlyCreatedProduct && (
        <main className="mx-auto flex min-h-screen flex-col items-center justify-center">
          ...
          <div className="product-creation-confirmation-title">
            {savingProduct
              ? "Creating your product"
              : "Your product was created and listed successfully!"}
          </div>
          <p className="product-creation-confirmation-paragraph">
            {savingProduct ? (
              "Trying to save it..."
            ) : (
              <>
                Redirecting you back to products listings in{" "}
                <span>{timeUntilRedirect} s</span>
              </>
            )}
          </p>
        </main>
