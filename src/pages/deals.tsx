...
const Home: NextPage = () => {
  ...
  conversationsByListing.forEach((listingConversation) => {
    const listingInfo = listings?.data?.find(
      (listing: any) => listing.id === listingConversation.listingId
    );
  ...
  useEffect(() => {
    ...
    if (_conversationId) {
      let _conversation = currentChat?.conversations?.find(
        (conv: any) => conv.fromUser == _conversationId
      );
  ...
  return (
    <>
      ...
      <main className="deals-wrapper">
        <div className="chat-wrapper flex flex-row">
          <div className="listed_products_inbox_wrapper">
            <div className="align-center flex flex-row gap-2 p-6">
          ...
          {router?.query?.listingId && (
            <>
              ...
              <div className="inner-chat-wrapper">
                <div className="align-center space-between flex flex-row gap-2 p-6">
                        ...
                        <div className="message left">
                          ...
                          <div className="inner-message">
                            ...
                            <span className="message-timestamp">
                              Sent · {moment(msg.deliveredAt).fromNow()}
                            </span>
                          </div>
                        </div>
                      ) : (
                ...
                <div className="send-message-wrapper">
                  <div className="inner-message-send flex flex-col">
                    <textarea
                      name="message"
                      id=""
                      placeholder={currentConversation?.userName}
                    ></textarea>
                    <div className="space-between flex p-3">
                      <div className="send-message-btn ml-auto">Send</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="chat-details-wrapper"></div>
            </>
          )}
          ...
          {!router?.query?.listingId && (
            <>
              <div className="w-70 placeholder-chat-wrapper">
                ...
                <h1>
                  No chat conversation selected. Please select one conversation
