    ...
    <>
      ...
      <div style={{ width: "100%" }}>
        ...
        <main className="container mx-auto flex min-h-screen flex-col gap-6">
          <div
            className="container mx-auto flex flex-row gap-6"
            style={{ alignItems: "self-start" }}
          >
            <div
              className="card saas-details-wrapper"
              style={{ border: "1px solid #efefef" }}
            >
              <div className="navigation-wrapper w-100 flex justify-between">
              ...
              <div className="card-header">
                <div className="left">
                  ...
                  <div className="product-name">
                    <div className="title">{listingItem.name}</div>
                    <span className="created-at">
                      Listed at {moment(listingItem?.createdAt).format()}
                    </span>
                  </div>
                </div>
                <div className="right location-wrapper flex">
                  <Icon icon="location" />
              ...
              <div className="section">
                ...
                <div className="list">
                  {listingItem.assets.map((asset) => (
                    <p key={asset} className="paragraph list-item">
                      {asset}/
                    </p>
                  ))}
                </div>
            ...
            <div style={{ width: "40%", border: "1px solid #efefef" }}>
              <div className="metrics-overview-wrapper card no-padding-x">
                ...
                <div className="images-wrapper">
                  <div className="image">
                    <img
                      src="https://upcdn.io/FW25bBB/image/content/app_screens/db79e46a-1b8a-41fb-9dc4-649fd95ac42f.png?f=webp&w=1920&q=85&fit=shrink-cover&extend-bottom=120&image=%2Fwatermark%2Fdbc9efc5-2c2a-439a-915a-853ca8c242a2&gravity=bottom"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div className="metrics-overview-wrapper card">
                ...
                <div className="kpi-container-wrapper flex">
